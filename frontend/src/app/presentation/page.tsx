/**
 * Présentation institutionnelle de Pactiva (français), servie sur `/presentation`.
 * La racine `/` est désormais la page reviewer anglaise (docs/pactiva-reviewer-demo) ;
 * cette page reste accessible depuis son pied de page (« Français »).
 * Présente l'ambition de Pactiva
  ...
  return (
    <main className="theme-light min-h-screen bg-bg text-ink">
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        <Link href="/" aria-label="Pactiva — présentation" className="text-brand-navy-500">
          <Logo size={26} />
        </Link>
