...
export const FIXTURE_GOLD_DOCUMENTS = [
  {
...
export const FIXTURE_GOLD_DETAIL = {
  ...
  sentences: [
    {
      ...
      annotators: [
        { voterId: "alice", userId: 11, displayName: "Alice", color: "#3B82F6", primary: "TERMINATION", secondaries: [] },
        { voterId: "bob", userId: 12, displayName: "Bob", color: "#10B981", primary: "TERMINATION", secondaries: [] },
      ],
      llms: [
        { judge: "claude", primary: "TERMINATION" },
        { judge: "codex", primary: "TERMINATION" },
        { judge: "mistral", primary: "TERMINATION" },
      ],
      agreementClass: "strict" as const,
      riskBand: "low" as const,
      autoLevel: "auto_1click" as const,
      confidence: 1,
      humanDissent: false,
    ...
    {
      // Désaccord ENTRE ANNOTATEURS (les LLM ne sont qu'une référence).
      index: 1,
      text: "We may share your data with partners.",
      annotators: [
        { voterId: "alice", userId: 11, displayName: "Alice", color: "#3B82F6", primary: "PRIVACY", secondaries: [] },
        { voterId: "bob", userId: 12, displayName: "Bob", color: "#10B981", primary: "LIABILITY", secondaries: [] },
      ],
      llms: [
        { judge: "claude", primary: "PRIVACY" },
        { judge: "codex", primary: "LIABILITY" },
        { judge: "mistral", primary: "PRIVACY" },
      ],
      agreementClass: "divergence" as const,
      riskBand: "high" as const,
      autoLevel: "manual" as const,
      confidence: 0.5,
      humanDissent: false,
      proposedPrimary: "PRIVACY",
      proposedSecondaries: [],
      decided: false,
      autoResolved: false,
      primary: "",
    ...
    {
      index: 2,
      text: "Disputes are resolved by arbitration.",
      annotators: [
        { voterId: "alice", userId: 11, displayName: "Alice", color: "#3B82F6", primary: "ARBITRATION", secondaries: [] },
        { voterId: "bob", userId: 12, displayName: "Bob", color: "#10B981", primary: "JURISDICTION", secondaries: [] },
      ],
      llms: [{ judge: "claude", primary: "ARBITRATION" }],
      agreementClass: "divergence" as const,
      riskBand: "high" as const,
      autoLevel: "manual" as const,
      confidence: 0.2,
      humanDissent: false,
      proposedPrimary: "ARBITRATION",
      proposedSecondaries: [],
      decided: false,
      autoResolved: false,
      primary: "",
...
export const FIXTURE_GOLD_CONFIG = {
  ...
  annotatorWeights: {},
  signalBonus: 0.2,
  autoResolve: { absoluteAgreement: true, majority: true, lowRiskLevels: ["C1", "C2"], manualLevels: ["C3", "C4", "C5"] },
  arbiters: [] as string[],
  autoShare: true,
