O% Version de dépôt (grâce d'édition) — Submission 157 (JURIX 2026, long paper, ≤ 10 pages hors références).
...
\IfFileExists{tables/T3_queries.tex}{\input{tables/T3_queries.tex}}{%
\begin{table}[t]
...
\IfFileExists{tables/T4_cost.tex}{\input{tables/T4_cost.tex}}{\begin{table}[t]\caption{The price of interpretability (pending: generated table not found).}\label{tab:cost}\centering\footnotesize ---\end{table}}
