...
| `baselines/B2_legal-bert_holdout_predictions.jsonl` | `legal-kg/results/baselines/B2_lab_bb37a8ce/predictions.jsonl` | 6498355 | `323483e37fdfea7b` | Discussion : scores de Legal-BERT sur les 22 phrases retrouvées seulement par les requêtes (13 < 0,1 ; 17 < 0,25) |
...
| `evaluation/sentences_eval_pass0.jsonl` | `legal-kg/results/evaluation/holdout-v02-pass0/sentences_eval.jsonl` |  | `cc197a0e395b438a` | décisions par phrase (référence, requêtes, thème seul, B1, B2) de l'évaluation passe 0 ; entrée de l'analyse post hoc |
| `evaluation/POSTHOC_complementarity.json` | produit par `jurix2026-long-paper/tools/post_hoc_complementarity.py` (lit seulement `artifacts/`) | — | `fc3af2912c45559a` | § 9 (analyse post hoc, non pré-enregistrée) : 22 phrases retrouvées par les seules requêtes, 13 avec score encodeur < 0,1, 17 < 0,25 ; union naïve F1 0,61 |
