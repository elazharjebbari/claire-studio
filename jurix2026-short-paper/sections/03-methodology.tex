...
Table~\ref{tab:systems}), prompted once with the same vocabulary on the same
sentences, in June and August 2026, with prompts released alongside the data;
their outputs were stored and never regenerated. Individual votes are retained rather than collapsed into a
