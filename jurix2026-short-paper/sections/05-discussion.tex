...
could survive. \textsc{Fable} is also the only judge whose accuracy rises where the
annotators split (0.607 on unanimous sentences, 0.636 on majority-decided ones,
against 0.578 and 0.543 for \textsc{Claude}), the signature one would expect of
anchoring rather than competence. Excluding it leaves \textsc{Claude} at
