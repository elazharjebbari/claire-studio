...
the agreement gain consolidation yields below. The two effects that the literature tends to conflate are therefore
...
We report these figures rather than demonstrate them (Section~\ref{sec:discussion}).
Their ordering is nonetheless unambiguous: a compact, domain-specific encoder
outperforms every judge while remaining well below the human ceiling.
