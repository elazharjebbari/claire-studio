...
| **7 Détection** | règles + baselines + approches | 5, 6 | règles gelées ; moteur ; B0–B4 ; A3–A8 | `graph/rules/`, `src/detection/`, runs | 6 | Gate 6 (baseline reproductible) | fuite ; règles ajustées | P0 |
